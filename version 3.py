...
def checkAnswer():
    ...
    if str(answer.get()) == givenAnswer.get():
        ...
        resultLabel = Label(root , text="Incorrect" , font=('arial' , 20), fg="green")
...
headingLabel = Label(root , text="Maths Quiz" , font=('arial' , 25) , fg = "#45CAFF" ,  )
...
completeQuestionLabel = Label(root , text="10th question" , fg = "#45CAFF" , )
...
submitButton = Button(root , text="Submit" , fg="#45CAFF", bg="#000000", font=('arial' , 15) , command=checkAnswer)
submitButton.grid(row=3 , column=1)

resultLabel = Label(root , text="Result" , font=('arial' , 20) , fg="#7AFF70" , )
resultLabel.grid(row=4 , column=0)
